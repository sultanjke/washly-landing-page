    ...
    return (
        ...
        >
            <div className="max-w-6xl mx-auto text-center scale-[1.08]">
                <h2 className="mb-25 text-5xl font-bold text-gray-900 transition-colors dark:text-white">Как выглядит работа с washly.kz</h2>
                <div className="relative mx-auto sm:mt-4">
                    <div
                        className="
                          absolute left-0 right-0 top-1/4 -translate-y-1/2
                          h-[0.2rem] bg-black dark:bg-white/70
                          hidden sm:block
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-5 gap-14 sm:gap-10 items-start">
                        {steps.map((s, i) => (
                            <div key={i} className="relative z-10 flex flex-col items-center text-center">
                                <div
                                    className="mb-4 flex h-16 w-16 items-center justify-center rounded-3xl bg-black text-3xl font-bold text-white shadow-[0_10px_30px_rgba(0,0,0,0.25)] sm:h-18 sm:w-18 dark:bg-white dark:text-black">
                                    {s.number}
                                </div>
